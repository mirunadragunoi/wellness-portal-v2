<template>
  <footer class="footer">
    <div class="footer__top">
      <div class="footer__brand">
        <span class="footer__logo">
          <img src="/logo.png" alt="logo" class="footer__logo-img" />
          {{ t('brand.name') }}
        </span>
    ...
    <div class="footer__bottom">
      ...
      <span class="footer__made">Made with 🌿</span>
    </div>
  </footer>
</template>
...
.footer__made { font-size:12px; color:var(--ink-500); }

@media (max-width:640px) {
  .footer__top { flex-direction:column; }
  .footer__links { flex-direction:row; flex-wrap:wrap; gap:14px; }
}
</style>
