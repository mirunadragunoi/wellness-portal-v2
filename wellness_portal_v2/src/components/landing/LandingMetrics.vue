    ...
    <div class="container">
      <div class="metrics__inner">
        ...
        <div class="metrics__grid">
          <div v-for="m in metrics" :key="m.imageKey" class="metric-block">
            <div class="metric-block__img" :style="{ backgroundImage:`url(${m.image})` }" />
            <div class="metric-block__val">{{ m.value }}</div>
...
const { t } = useI18n()
const metrics = [
  { value:'98%',    labelKey:'metrics.metric1', image:LANDING_IMAGES.metric1 },
  { value:'12k+',   labelKey:'metrics.metric2', image:LANDING_IMAGES.metric2 },
  { value:'4.9★',   labelKey:'metrics.metric3', image:LANDING_IMAGES.metric3 },
]
</script>
