<template>
  <section class="hero">
    ...
    <div class="hero__right" :style="{ backgroundImage: `url(${heroMain})` }">
      ...
      <!-- Breathing orb on photo -->
      <div class="hero__orb">
        <div class="hero__orb-ring" />
        <div class="hero__orb-core">
          <span class="hero__orb-word">Breathe</span>
          <span class="hero__orb-sub">Inhale · Hold · Exhale</span>
        </div>
      </div>
    </div>
  </section>
...
.hero__right-overlay {
  ...
  background:linear-gradient(160deg, rgba(28,26,22,0.28) 0%, rgba(28,26,22,0.12) 100%);
}
...
.hero__orb-word { font-family:var(--font-display); font-size:20px; font-style:italic; color:white; }
.hero__orb-sub  { font-size:11px; color:rgba(255,255,255,0.7); letter-spacing:0.5px; }
