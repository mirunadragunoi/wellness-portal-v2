...
<style scoped>
.session-view { min-height: var(--app-min-height); display: flex; flex-direction: column; background: var(--ink-900); }
...
.session-view__empty {
  ...
  gap: 20px; min-height: var(--app-min-height); color: var(--parchment); background: var(--ink-900);
}
.session-view__empty p { font-size: 16px; color: var(--ink-400); }
