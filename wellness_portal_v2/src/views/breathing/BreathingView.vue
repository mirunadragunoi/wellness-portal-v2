...
.breathing-view__back {
  ...
  padding: 7px 14px; border: 1.5px solid var(--ink-700);
  border-radius: var(--radius-sm); transition: all var(--duration-fast);
}
.breathing-view__back:hover { color: var(--parchment); border-color: var(--sage-500); }
.breathing-view__title { font-family: var(--font-display); font-size: 36px; font-weight: 300; color: var(--parchment); margin-bottom: 8px; }
.breathing-view__desc  { font-size: 15px; color: var(--ink-400); }
.breathing-view__stats { display: flex; flex-direction: column; align-items: center; gap: 10px; }
.breathing-view__remaining { font-family: var(--font-display); font-size: 24px; color: var(--ink-300); }
.breathing-view__rounds    { font-size: 13px; color: var(--ink-500); text-transform: uppercase; letter-spacing: 1px; }
...
.breathing-complete h2 { font-family: var(--font-display); font-size: 36px; font-weight: 300; color: var(--parchment); }
.breathing-complete p  { font-size: 15px; color: var(--ink-400); max-width: 360px; line-height: 1.6; }
...
.bc-btn--ghost { background: transparent; color: var(--ink-300); border-color: var(--ink-600); }
.bc-btn--ghost:hover { color: var(--parchment); border-color: var(--ink-400); }
</style>
