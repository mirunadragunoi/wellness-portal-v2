...
.goal-chip--edit:hover { background: var(--ink-900); color: var(--parchment); border-color: var(--ink-900); }
...
.profile-logout-btn:hover { background: #dc2626; color: white; border-color: #dc2626; }
