<template>
  <div class="auth-page">
    <RouterLink to="/" class="auth-page__logo">
      <img src="/logo.png" alt="Wellness portal logo" class="auth-page__logo-image" />
      {{ t('brand.name') }}
    </RouterLink>
...
.auth-page::before {
  ...
  background: var(--ink-900); pointer-events: none;
}
.auth-page__logo {
...
.auth-btn {
  width: 100%; padding: 14px; border-radius: var(--radius-sm); border: 2px solid var(--ink-900);
  cursor: pointer; background: var(--ink-900); color: var(--parchment);
